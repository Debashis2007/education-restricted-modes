...
**Parent system design:** [06 — Multi-Layer Safety / Moderation](https://github.com/Debashis2007/education-restricted-modes/blob/main/06-safety-moderation-pipeline.md)
...
User profile (education/family) → restricted policy pack
  ...
  → tool allowlist reduced ([07](https://github.com/Debashis2007/education-restricted-modes/blob/main/07-agent-runtime-containment.md))
